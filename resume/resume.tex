...
\section{Projects}
\runsubsection{Common Cell Atlas}
...
\item Uses a variational autoencoder to simplify multi-dimensional data.
\item Web application written in React.js.
\end{tightemize}
\sectionsep
...
Working with \textbf{\href{https://github.com/sbooeshaghi}{Sina Booeshaghi}} and \textbf{\href{https://liorpachter.wordpress.com/}{Prof Lior Pachter}}, along with Caltech Data, on the Common Cell Atlas (above).
\sectionsep
